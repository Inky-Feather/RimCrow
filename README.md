...
- 第一次使用：先看 [发布版下载与升级](#发布版下载与升级)、[普通用户快速上手](#普通用户快速上手)，再看 [快速上手](./doc/快速上手.md)。
- 路径和启动：看 [环境管理与路径说明](./doc/环境管理与路径说明.md)，适合处理多环境、Steam 启动、工坊挂载和快捷方式。
- 列表和排序：看 [模组列表与加载顺序说明](./doc/模组列表与加载顺序说明.md)、[自动排序与规则说明](./doc/自动排序与规则说明.md)。
- 下载和来源：看 [工坊与下载来源说明](./doc/工坊与下载来源说明.md)，适合区分 Steam 订阅、SteamCMD、合集、Git 和 zip 来源。
- 备份和迁移：看 [备份与导入导出说明](./doc/备份与导入导出说明.md)，适合恢复列表、导入分享码、换电脑和打包 Mod。
- 排错和 AI：看 [日志排错与 AI 诊断说明](./doc/日志排错与AI诊断说明.md)，适合处理红字、坏档、启动失败和日志分析。
- 贴图优化：看 [贴图优化说明](./doc/贴图优化说明.md)。
- 开发和翻译：看 [开发与本地运行](#开发与本地运行)、[Steamworks 运行库](#steamworks-运行库)、[多语言与翻译贡献](#多语言与翻译贡献)。
...
- 模组扫描、启用 / 停用列表、分组、标签、颜色、备注和批量编辑；详细说明见 [模组列表与加载顺序说明](./doc/模组列表与加载顺序说明.md)。
- 多环境管理、游戏路径识别、用户数据隔离、工坊/管理器模组链接部署、游戏启动和环境快捷方式；详细说明见 [环境管理与路径说明](./doc/环境管理与路径说明.md)。
- 加载顺序查看、保存、备份、差异对比和多格式导入导出；详细说明见 [备份与导入导出说明](./doc/备份与导入导出说明.md)。
- 自动排序、社区规则、用户规则、依赖关系、联锁模组和常见问题提示；详细说明见 [自动排序与规则说明](./doc/自动排序与规则说明.md)。
- Steam Workshop 搜索、工坊 ID 搜索、合集解析、SteamCMD 下载、Steam 客户端订阅管理和内置工坊浏览；详细说明见 [工坊与下载来源说明](./doc/工坊与下载来源说明.md)。
- GitHub / GitLab / GitGud / zip 直链等 Git 模组来源订阅、部署记录和推荐清单来源补全；详细说明见 [工坊与下载来源说明](./doc/工坊与下载来源说明.md)。
...
- 游戏日志查看、错误聚类、文件内容搜索和 AI 日志诊断辅助；详细说明见 [日志排错与 AI 诊断说明](./doc/日志排错与AI诊断说明.md)。
