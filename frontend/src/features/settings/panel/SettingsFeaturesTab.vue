                ...
                <div class="space-y-6">
                  <div class="modal-section space-y-4 p-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                      ...
                      <CommonSwitch class="col-span-1" :label="t('ui.settings.features.file_size_scan', '扫描时检查文件大小')" v-model="formData.enable_file_size_scan" :description="t('ui.settings.features.file_size_scan_desc', '开启后，扫描时会自动检查 Mod 的文件大小，以此识别新增或更新的内容。该功能会增加扫描耗时，但能显著提高文件变动的识别精度。')" />
