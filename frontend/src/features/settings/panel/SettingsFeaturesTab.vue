                ...
                <div class="space-y-6">
                  <div class="modal-section space-y-4 p-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                      ...
                      <CommonSwitch class="col-span-1" :label="t('ui.settings.features.startup_inventory_first_seen_mod_changes', '仅提醒首次模组变动')" v-model="formData.startup_inventory_first_seen_mod_changes" :description="t('ui.settings.features.startup_inventory_first_seen_mod_changes_desc', '开启后，软件启动时只弹出本次新发现的模组变动；以前已经提醒过但还没处理的模组变动，不会反复弹出。关闭后，只要模组变动还存在，每次启动都会提醒。')" />
