<template>
  ...
  >
    <div class="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center">
      ...
      >
        <div
          class="absolute bottom-0 right-0 z-20 h-full w-40 bg-slate-950 mask-[linear-gradient(to_left,white,transparent)]"
        />
        <div
          class="absolute bottom-0 right-0 z-20 h-40 w-full bg-slate-950 mask-[linear-gradient(to_top,white,transparent)]"
        />
      </div>
      ...
      <div class="absolute inset-auto z-40 h-44 w-full -translate-y-50 bg-slate-950"></div>
    </div>
